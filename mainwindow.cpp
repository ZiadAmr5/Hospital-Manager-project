    ...
    , m_hosp(h)
{
    ...
    connect(ui->RegisterButton, &QPushButton::clicked, this, &MainWindow::onRegisterClick);//connection function
}
...
void MainWindow::onRegisterClick()
{
    ...
    AppointmentWindow *app = new AppointmentWindow(m_hosp, this); //declare the appointment window
    app->show();//show it
}
